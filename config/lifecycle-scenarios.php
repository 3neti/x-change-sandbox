...
return [
    ...
    'scenarios' => [
        ...
        */
        ...
        /*
        |--------------------------------------------------------------------------
        | Execution Engine contract demo scenarios
        |--------------------------------------------------------------------------
        |
        | These local scenarios prove that x-change can issue vouchers with explicit
        | voucher-owned execution instructions and then execute them through the
        | voucher ExecutionEngine while resolving gateway implementations from
        | x-change. They do not perform provider, wallet, journal, action, or
