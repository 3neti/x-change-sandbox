...
| `3neti/wallet` | runtime | MIT / private-first public candidate | `3neti/wallet` | `v1.1.0` | 0 after `b9a1706` | release-after-fix | [Audit complete](./X_CHANGE_WALLET_RELEASE_AUDIT.md): 91 tests pass and Finder cleanup is committed, but README, direct framework constraints, Laravel 13 CI, semantic versioning, and clean-consumer validation block release. |
