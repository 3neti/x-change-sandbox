...
Current status: Cockpit Wave 9D compiler runtime seam implemented; next is template registry
...
| 4 | x-change Cockpit | Operator shell | Cockpit Wave 9D compiler runtime seam implemented; next is template registry | [../ui-cockpit/COMPASS.md](../ui-cockpit/COMPASS.md) |
