...
Current status: Closed; dashboard connected services are scan-first and host-published
...
| 4 | x-change Cockpit | Operator shell | Dashboard connected-service overview productization closed | [../ui-cockpit/COMPASS.md](../ui-cockpit/COMPASS.md) |
