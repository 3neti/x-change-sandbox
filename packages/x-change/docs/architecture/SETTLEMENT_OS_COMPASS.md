...
Current status: Cockpit Slice 15 Cockpit Dashboard Read Model Adapter Baseline complete
...
| 4 | x-change Cockpit | Operator shell | Slice 15 complete | [../ui-cockpit/COMPASS.md](../ui-cockpit/COMPASS.md) |
...
2. Completed slice: Cockpit Slice 15 — Cockpit Dashboard Read Model Adapter Baseline.
3. Read the Cockpit compass before continuing: `packages/x-change/docs/ui-cockpit/COMPASS.md`.
4. Recommended next slice: Cockpit Slice 16 — Quick Generate Read Model Adapter Baseline.
5. Slice 16 should add read-only Quick Generate planning facts only where existing x-change template/pricing/read services can provide sanitized facts.
