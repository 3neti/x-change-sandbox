...
Current status: Cockpit Wave 27 complete; operator activity filter UX refinement and multi-select decision complete
...
| 4 | x-change Cockpit | Operator shell | Cockpit Wave 27 complete; operator activity filter UX refinement and multi-select decision complete | [../ui-cockpit/COMPASS.md](../ui-cockpit/COMPASS.md) |
