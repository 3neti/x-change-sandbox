...
Current status: Cockpit Wave 28 complete; operator activity filter browser acceptance and next runtime decision complete
...
| 4 | x-change Cockpit | Operator shell | Cockpit Wave 28 complete; operator activity filter browser acceptance and next runtime decision complete | [../ui-cockpit/COMPASS.md](../ui-cockpit/COMPASS.md) |
