...
Current status: Cockpit Slice 18 Quick Generate Request Draft Contract Baseline complete
...
| 4 | x-change Cockpit | Operator shell | Slice 18 complete | [../ui-cockpit/COMPASS.md](../ui-cockpit/COMPASS.md) |
...
2. Completed slice: Cockpit Slice 18 — Quick Generate Request Draft Contract Baseline.
3. Read the Cockpit compass before continuing: `packages/x-change/docs/ui-cockpit/COMPASS.md`.
4. Recommended next slice: Cockpit Slice 19 — Quick Generate Authorization Gate Baseline.
5. Slice 19 should define read-only operator authorization gate facts before any mutation route or generation action is enabled.
