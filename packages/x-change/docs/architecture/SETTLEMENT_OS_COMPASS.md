...
Current status: Cockpit Wave 30 complete; Pay Code Explorer read-only functional filter parity complete
...
| 4 | x-change Cockpit | Operator shell | Cockpit Wave 30 complete; Pay Code Explorer read-only functional filter parity complete | [../ui-cockpit/COMPASS.md](../ui-cockpit/COMPASS.md) |
