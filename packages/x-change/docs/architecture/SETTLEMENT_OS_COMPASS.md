...
Current status: Cockpit Slice 25 Quick Generate Mutation Preconditions Review complete
...
| 4 | x-change Cockpit | Operator shell | Slice 25 complete | [../ui-cockpit/COMPASS.md](../ui-cockpit/COMPASS.md) |
...
2. Completed slice: Cockpit Slice 25 — Quick Generate Mutation Preconditions Review.
3. Read the Cockpit compass before continuing: `packages/x-change/docs/ui-cockpit/COMPASS.md`.
4. Recommended next slice: Cockpit Slice 26 — Quick Generate Mutation Authorization Decision Point.
5. Slice 26 should request explicit human approval before scaffolding any mutation route.
