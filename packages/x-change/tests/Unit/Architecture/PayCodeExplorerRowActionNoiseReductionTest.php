...
it('documents pay code explorer row action noise reduction slice 1', function (): void {
    ...
    expect($report)
        ...
        ->and($component)->toContain('MoreHorizontal')
        ->and($component)->toContain('More row actions')
...
it('documents pay code explorer row action noise reduction slice 2 closure', function (): void {
    ...
    expect($report)
        ...
        ->and($hostComponent)->toContain('MoreHorizontal')
        ->and($hostComponent)->toContain('More row actions')
