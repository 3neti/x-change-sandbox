...
it('documents pay code explorer result volume pagination polish slice 1', function (): void {
    ...
    expect($report)
        ...
        ->and($component)->toContain('cockpit-pay-code-results-density-summary')
        ->and($component)->toContain('cockpit-pay-code-result-pagination-footer')
        ->and($component)->toContain('of {{ records.length }} · Page {{ currentPage }} of')
        ...
        ->and($hostComponent)->toContain('cockpit-pay-code-results-density-summary')
        ->and($hostComponent)->toContain('cockpit-pay-code-result-pagination-footer')
        ->and($hostComponent)->toContain('of {{ records.length }} · Page {{ currentPage }} of')
