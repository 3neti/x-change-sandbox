...
it('documents pay code explorer search toolbar density polish slice 1', function (): void {
    ...
    expect($report)
        ...
        ->and($component)->toContain('Search Pay Codes')
        ->and($component)->toContain('h-9')
        ...
        ->and($component)->toContain('Search')
        ->and($component)->toContain('Clear')
        ->and($frontendTest)->toContain('Search Pay Codes')
...
it('documents pay code explorer search toolbar density polish slice 2 closure', function (): void {
    ...
    expect($report)
        ...
        ->and($component)->toContain('Search Pay Codes')
        ->and($hostComponent)->toContain('Search Pay Codes')
        ->and($hostComponent)->toContain('h-9')
