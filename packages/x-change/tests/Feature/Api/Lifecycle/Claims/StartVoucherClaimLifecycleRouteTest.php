...
it('returns redemption preparation metadata via the lifecycle route surface', function () {
    ...
    $response = $this->postJson('/api/x/v1/vouchers/code/'.$voucher->code.'/claim/start');
...
it('returns not found when voucher code does not exist through the lifecycle route surface', function () {
    $response = $this->postJson('/api/x/v1/vouchers/code/DOES-NOT-EXIST/claim/start');
