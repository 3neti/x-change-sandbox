...
it('preserves campaign context and mobile validation through the quick generate runtime handoff', function (): void {
    ...
    $this
        ...
        ->assertJsonPath('result.links.redeem', 'https://example.test/r/PC-WAVE-52D')
        ->assertJsonPath('result.links.redeem_path', '/r/PC-WAVE-52D')
        ->assertJsonPath('result.links.cockpit_detail', '/x/cockpit/pay-codes/PC-WAVE-52D')
        ->assertJsonPath('result.links.cockpit_distribution', '/x/cockpit/pay-codes/PC-WAVE-52D/distribution')
        ...
        ->assertJsonMissingPath('feedback_delivery')
