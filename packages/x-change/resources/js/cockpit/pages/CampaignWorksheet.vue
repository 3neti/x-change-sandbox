        ...
        >
            ...
            >
                <div>
                    ...
                    >
                    <p
                        class="mt-2 text-[0.65rem] font-semibold tracking-[0.18em] text-slate-500 uppercase dark:text-slate-400"
                    >
                        {{ props.worksheet.profile }} worksheet
                    </p>
                    <h1
                        class="mt-0.5 text-xl font-semibold text-slate-950 dark:text-slate-50"
                    >
                        {{ props.worksheet.name }}
                    </h1>
                </div>
                <div
                    class="rounded-xl bg-slate-50 px-4 py-2 text-right dark:bg-slate-950"
                >
