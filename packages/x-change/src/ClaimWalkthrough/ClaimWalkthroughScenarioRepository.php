    ...
    public function all(): array
    {
        ...
        return [
            ...
            'claim_named_three_slices_preview' => [
                ...
                'description' => 'No-money issuer preview for a ₱150 Pay Code split into three named claim slices.',
                'fixture' => [
                    'amount' => '150.00',
                    'money_movement' => false,
                    'form_flow_default_splash' => false,
                    ...
                    'slices' => [
                        [
                            'id' => 'breakfast',
                            'amount' => '50.00',
                            'description' => 'Breakfast allowance',
                            'tag' => 'Meal',
                        ],
                        [
                            'id' => 'transport',
                ...
                'checkpoints' => [
                    [
                        ...
                        'route' => '/x/claim',
                        'actor' => 'redeemer',
                        'expected' => 'Redeemer starts at /x/claim before entering a Pay Code.',
                        'screenshot' => 'screenshots/01-claim-entry.png',
                    ],
                    [
                        'key' => 'xray-preview',
                        'title' => 'Named slice x-ray preview',
                        'route' => '/x/claim',
                        'actor' => 'redeemer',
                        'expected' => 'The entered Pay Code reveals three named slices before proceeding.',
                        'screenshot' => 'screenshots/02-xray-preview.png',
                    ],
                    [
                        'key' => 'named-slice-selection',
                        'title' => 'Named slice selected',
                        'route' => '/x/claim',
                        'actor' => 'redeemer',
                        'expected' => 'Redeemer selects a named slice, enabling the claim to continue.',
                        'screenshot' => 'screenshots/03-named-slice-selection.png',
                    ],
                    [
                        'key' => 'generic-payout-form',
                        'title' => 'Generic payout form',
                        'route' => '/form-flow/{flow_id}',
                        'actor' => 'redeemer',
                        'expected' => 'Redeemer chooses claim details for the named-slice Pay Code.',
                    ...
                    [
                        ...
                        'actor' => 'redeemer',
                        'expected' => 'Redeemer payout details are filled before moving to confirmation.',
                        'screenshot' => 'screenshots/05-generic-payout-form-filled.png',
                    ],
                    [
                        'key' => 'confirmation',
                        'title' => 'Claim confirmation',
                        'route' => '/x/claim/{code}/confirm',
                        'actor' => 'redeemer',
                        'expected' => 'Redeemer reviews the selected named slice and payout details before final confirmation.',
                        'screenshot' => 'screenshots/06-confirmation.png',
                    ],
                    [
                        'key' => 'claim-success',
                        'title' => 'Claim success',
                        'route' => '/x/claim/{code}/success',
                        'actor' => 'redeemer',
                        'expected' => 'The journey ends on the x-change success state after claiming one named slice.',
                        'screenshot' => 'screenshots/07-claim-success.png',
                    ],
                ],
            ],
