...
class ExecutionResultHandoffSummaryJournalPayloadData extends Data
{
    /**
    ...
    public function __construct(
        public readonly string $schema = 'x-change.execution-handoff-summary-journal-payload.v1',
        public readonly string $event_name = 'execution.handoff.summary.recorded',
