...
class GeneratePayCodeCommand extends Command
{
    ...
    protected $description = 'Generate a Pay Code from voucher instructions.';

    public function handle(GeneratePayCode $action): int
    {
        ...
        $this->renderPayload($result->toArray(), 'Pay Code generated successfully.');
